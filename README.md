...
I have extended this project to generate *sets* of MTG cards with interesting interactions. See the [MTG AI Card Set Generator](https://huggingface.co/spaces/kestrel256/mtg-ai-card-set-generator).
